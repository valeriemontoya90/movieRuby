...
class UserMoviesControllerTest < ActionController::TestCase
  ...
  test "should create user_movie" do
    assert_difference('UserMovie.count') do
      post :create, user_movie: { movie_id: @user_movie.movie_id, user_id: @user_movie.user_id, view: @user_movie.view }
    end
  ...
  test "should update user_movie" do
    patch :update, id: @user_movie, user_movie: { movie_id: @user_movie.movie_id, user_id: @user_movie.user_id, view: @user_movie.view }
    assert_redirected_to user_movie_path(assigns(:user_movie))
  end
